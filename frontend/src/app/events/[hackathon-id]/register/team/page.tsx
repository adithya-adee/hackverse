      ...
      <div className="mt-18 w-full md:w-[90%] mx-auto grid grid-cols-6 gap-4">
        <div className="col-span-4">
          <div className="shadow-sm rounded-2xl bg-[var(--primary-2)] w-[30%]">
            <div className="flex space-x-8 px-6">
              <motion.button
                ...
                className={`w-full z-50 m-2 p-3 font-bold text-sm rounded-xl ${activeTab === "Create Team"
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.98 }}
                transition={{ type: "spring", stiffness: 300 }}
                className={`w-full z-50 m-2 p-3 font-bold text-sm rounded-xl ${activeTab === "Join Team"
                  ? "bg-gradient-to-r from-blue-500 to-green-500 text-white"
                  : "text-gray-500 hover:text-gray-700 hover:border-gray-300"
                  }`}
              >
          ...
          <div className="shadow-lg rounded-2xl border-t-[1px] bg-[var(--primary-1)] p-2 my-4 ">
            {activeTab == "Create Team" && <CreateTeamSection hackathonId={hackathonId} />}
            {activeTab == "Join Team" && <JoinTeamView hackathonId={hackathonId} />}
          </div>
        </div>
